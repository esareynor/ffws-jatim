                        ...
                        >
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-semibold text-gray-700">
                                    Titik Sampling Kualitas Air Dinas PU SDA
                                </span>
                            </div>
                            {showSamplingAir ? (
                                <ChevronUp className="w-4 h-4 text-gray-600" />
                    ...
                    <section className="mt-4 space-y-4">
                        ...
                        >
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-semibold text-gray-700">
                                    Pos Tinggi Muka Air Dam Provinsi Jawa Timur
                                </span>
                            </div>
                    ...
                    <section className="mt-4 space-y-4">
                        ...
                        {showPosHujan && (
                            <div className="pl-4 pt-2 pb-4 space-y-2">
                                {[
                                    {
                                        id: "pos-hujan-ws-brantas-pjt1",
                                        name: "Pos Hujan WS Brantas PJT 1",
                                        color: "#FF6347",
                                    },
                                    {
                                        id: "pos-hujan-ws-bengawan-solo",
                                        name: "Pos Hujan WS Bengawan Solo PJT 1",
                                        color: "#FFA500",
                                    },
                                    {
                    ...
                    <section className="mt-4 space-y-4">
                        ...
                        {showPosDugaAir && (
                            <div className="pl-4 pt-2 pb-4 space-y-2">
                                {[
                                    {
                                        id: "pos-duga-air-ws-brantas-pjt1",
                                        name: "Pos Duga Air WS Brantas PJT 1",
                                        color: "#FF6347",
                                    },
                                    {
                                        id: "pos-duga-air-ws-bengawan-solo",
                                        name: "Pos Duga Air WS Bengawan Solo PJT 1",
                                        color: "#FFA500",
                                    },
                                    {
                                        id: "pos-duga-air-jam-jam-an",
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span
                                                className="w-3 h-3"
                                                style={{ backgroundColor: item.color, borderRadius: 4 }}
                                            ></span>
                                            <span className="text-xs text-gray-700">{item.name}</span>
                                        </div>
                                        <button
                    ...
                    <div className="mt-6 p-4 bg-amber-50 rounded-lg border border-amber-200">
                        <div className="flex items-start gap-2">
                            ...
                            <div className="text-xs text-amber-800">
                                ...
                                <div className="mt-1">
                                    Klik panah di sebelah "Map Layers" atau "Legenda Peta" untuk melihat detailnya.
                                </div>
                            </div>
                        </div>
                    </div>
