...
//             // Jika isPlaying false dan bukan pending stop, pastikan interval dihentikan
//             if (intervalRef.current) {
//                 clearInterval(intervalRef.current);
//                 intervalRef.current = null;
...
//             }
//         }
//     }, [currentStationIndex, isPlaying]); // Tambahkan isPlaying ke dependency

//     // Event listener
//     useEffect(() => {
//         const handleUserInteraction = (event) => {
//             // ✅ Hanya tanggapi jika sedang berjalan (isPlaying = true)
...
//                 }
//             } else {
//                 // Jika isPlaying = false, abaikan user interaction
//                 console.log("User interaction detected but auto switch is not playing, ignoring.");
//             }
//         };
...
//         };
//     }, [isPlaying, isPendingStop, interval, tick]); // Hapus stopAutoSwitch dari dependency
