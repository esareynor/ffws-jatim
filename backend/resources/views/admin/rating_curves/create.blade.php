...
@section('title', 'Tambah Rating Curve')
@section('page-title', 'Tambah Rating Curve')
@section('page-description', 'Tambah rating curve baru')
@section('breadcrumb', 'Tambah Rating Curve')

@section('content')
<div class="max-w-3xl mx-auto" x-data="ratingCurveForm()">
    <div class="card-dark shadow-sm rounded-lg">
        <div class="p-6">
            <form action="{{ route('admin.rating-curves.store') }}" method="POST" class="space-y-6">
                @csrf
