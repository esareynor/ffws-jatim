...
@section('title', 'Tambah Calculated Discharge')
@section('page-title', 'Tambah Calculated Discharge')
@section('page-description', 'Tambah data debit terhitung manual')
@section('breadcrumb', 'Tambah Calculated Discharge')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="card-dark shadow-sm rounded-lg">
        <div class="p-6">
            <form action="{{ route('admin.calculated-discharges.store') }}" method="POST">
                @csrf
                ...
                <div id="rating-curve-info" class="hidden mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
