...
const GoogleMapsSearchbar = ({
  ...
  const executeFlyTo = useCallback((coords) => {
        ...
        <form onSubmit={handleSearch} className="relative h-full">
          <div className={`bg-white rounded-lg shadow-lg transition-all duration-200 p-1.5 sm:p-2 h-full ${
            ...
            <div className="flex items-center h-full">
              {/* Search Icon */}
>>>>>>> 40517532a7633051cc7789b40140a43c0a46466a
...
<<<<<<< HEAD
              <div className="flex-shrink-0 ml-2">
                <button
                  ...
                  disabled
                >
                  <svg className="w-4 h-4 text-blue-600 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
