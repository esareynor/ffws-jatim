...
const FloodRunningBar = ({ onDataUpdate, onStationSelect, onMapFocus, isSidebarOpen = false }) => {
    ...
    return (
        <div
             className={`fixed top-20 sm:top-5 z-[70] transition-all duration-300 ease-in-out left-100 right-100 flood-running-bar mobile-flood-bar sm:desktop-flood-bar`}
        >
