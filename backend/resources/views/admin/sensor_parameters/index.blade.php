...
@section('content')
    <div class="container-fluid px-4 py-6" x-data="parameterManager('sensor')">
        ...
        <!-- Table -->
        <x-table title="Daftar Sensor Parameters" :headers="$tableHeaders" :rows="$parameters" searchable
            searchPlaceholder="Cari sensor parameters...">
            <x-slot:actions>
                <x-admin.button type="button" variant="primary" @click="openModal()">
                    <i class="fas fa-plus mr-2"></i>
                    Add Parameter
                    ...
                    <form @submit.prevent="saveParameter">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" x-model="form.code" required placeholder="e.g., WL, RF"
                        ...
                        async saveParameter() {
                            try {
                                ...
                                if (data.success) {
                                    ...
                                    this.$dispatch('close-modal', 'parameter-modal');
